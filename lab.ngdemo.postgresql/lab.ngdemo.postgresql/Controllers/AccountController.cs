...
namespace lab.ngdemo.postgresql.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult LogOn(LogOnViewModel model, string returnUrl)
        {
            ...
            {
                lab.ngdemo.postgresql.Models.User user = _userCacheHelper.GetUser(model.UserName);
        ...
        public ActionResult ChangePassword(ChangePasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                lab.ngdemo.postgresql.Models.User user = _userCacheHelper.GetUser(User.Identity.Name);
