...
angularModule.controller('StudentController', ['StudentService', '$scope', function (StudentService, $scope) {
    ...
    function getList() {
        StudentService.GetList().success(function (dataList) {
            ...
            var currentPage = 0;
            var numOfPagesTobeDisplayed = 5;
            var total = dataList[0].Total;
            var url = '/Student/GetListAjax';
            var search = {
                Keyword: $("#Keyword").val(),
                Page: 0,
                PageSize: 10
            ...
            var listPagingSettings = {
                ...
                numOfPagesTobeDisplayed: numOfPagesTobeDisplayed,
                totalNumberOfRecords: total,
                sorting: true,
                url: url,
                paramTobePassed: { search: search },
                callback: dataList,
                preLoader: $('#divGrid')
            };
